        ...
        <div class="login__body">
            <form wire:submit.prevent="login" class="login__form">
                ...
                <div class="form-group">
                    ...
                    <input type="email" wire:model="email" id="email" class="form-group__input login__input">
                </div>
                <div class="form-group">
                    <label for="password" class="form-group__label login__label">Password</label>
                    <input type="password" wire:model="password" id="password" class="form-group__input login__input">
                </div>
                <div class="form-group">
                    <button type="submit" class="button button--primary" wire:loading.class="button--disabled">
                        Login
                    </button>
                </div>
            </form>
